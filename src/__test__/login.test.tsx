...
describe("Login components Test", () => {
  it("input and button should be present", async () => {
    ...
    const inputEmail = await renderLogin.findAllByPlaceholderText(
      "e.g. lucasbeaugosse@email.com"
    );
    expect(inputEmail).toBeTruthy();
    const inputPassword = await renderLogin.findAllByPlaceholderText(
      "Enter your password"
    );
  ...
  it("input fields should accept user input", async () => {
    ...
    const inputEmail = (await findByPlaceholderText(
      "e.g. lucasbeaugosse@email.com"
    )) as HTMLInputElement;
    const inputPassword = (await findByPlaceholderText(
      "Enter your password"
    )) as HTMLInputElement;
